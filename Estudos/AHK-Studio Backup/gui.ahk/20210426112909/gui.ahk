...
; SORT ou DESC ou NoSort , "float" = conteudos dessa coluna vao ser float que contem decimal, "integer" = numeros inteiros, "text" = organizar alfabeticamente
...
LV_ModifyCol(3, "sort integer auto")
LV_ModifyCol(4, "desc integer auto") ; desc = sortea ao contrario
LV_ModifyCol(4, "NoSort integer auto") ; ignora o clique de coluna que organiza o sort

;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; ADICIONAR COLUNA, FUNÇÃO LV_InsertCol()
LV_InsertCol(3, "nosort center auto")

;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; EXCLUIR COLUNA E TUDO ABAIXO LV_DeleteCol()
LV_DeleteCol(4) ; só tem um parametro que é o numero da coluna que quer deletar
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;; PEGAR INFORMAÇÃO DA LISTVIEW - GETTING DATA
; LV_GetCount("s") - pega informações do tamanho de colunas ou linhas ou linhas selecionadas, se deixar em branco retorna o número de linhas do control
; "s" ou "selected" = retorna linhas selecionadas
; "column" = retorna numero de colunas
...
Gui Add, ListView, w300 h300 checked grid -readonly, Name|Size|Date Modified
...
listID := IL_Create(10, 0,  true)

Loop 50
	lista := LV_Add("", "Item" a_index, "500MB", a_now + a_index)
