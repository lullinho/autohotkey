...
; 2º parametro é as options que quer: 300(width/pixels) "auto" = se ajustar ao conteúdo
...
LV_ModifyCol(2, 300, "Modified Size Column") ; nas options colocamos 300 que é o width/pixels da coluna
Gui Show
return