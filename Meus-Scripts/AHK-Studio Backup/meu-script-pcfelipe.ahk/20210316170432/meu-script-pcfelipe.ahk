...
gui, Add, Checkbox, checked1 vstackAHKPT, Pt.StackOverflow.com/AutoHotkey
...
gui, Add, Checkbox, x320 yp+8 checked1 vquotes,Wrap Search in Double quotes ;Add check box to wrap in double quotes
gui, Show 
...
If stackAHKPT
	run "http://www.google.com/search?q=%SearchTerm%+site:https://pt.stackoverflow.com/questions/tagged/autohotkey"
If micro
